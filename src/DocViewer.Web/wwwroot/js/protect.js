...
(function () {
    ...
    // The password dialog and search bar are normal input fields, not document
    // content - they should behave like any other form (select/copy/paste/
    // right-click all work normally there), unlike the rest of the viewer.
    const isExempt = (target) => !!target?.closest(".password-dialog, .search-bar");
